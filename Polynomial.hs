...
-- evaluating a polynomial at a given value the brute force way
eval     :: (Num t, Enum t, Floating t) => [t] -> t -> t
eval l x =  sum $ zipWith (*) l [x**n | n <- [0..] ]

-- the nth horner element, given a polynomial and a value at which it needs
-- to be evaluated
...
-- calculate the derivative of a polynomial given
